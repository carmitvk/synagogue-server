      ...
      leftBoard: [
        {
          title: 'שיעורים בשבת',
          rows: [            
            { title: 'שיעור בפרקי אבות', value: '16:35' },
            { title: 'שיעור בפרשת שבוע', value: '17:05' },
            { title: 'לימוד מסכת סוכה', value: '17:35' },
          ],
          durationSec: 20,
          type: 'time&text'
        },
