...
let MOCK_VIEWS_DATA = [
      ...
      leftBoard: [
        {
          ...
          rows: [
            ...
            { title: 'שיעור פרשת שבוע', value: '16:35' },
            { title: 'מסכת ראש השנה', value: '17:35' },
  ...
  {
    viewName: 'תצוגה לשביעי של פסח',
    showDays: [],
    showDates: ['28042024', '29042024'],
    viewType: 'two-boards-view',
    viewFields: {
      title: 'שביעי של פסח',
      rightBoard: [
        {
          ...
          rows: [
            ...
            { title: 'מנחה מוקדמת', value: '13:20' },
            { title: 'מנחה חג', value: '19:15' },
            { title: 'ערבית מוצאי חג', value: '19:50' },
            // { title: 'מנחה שבת', value: 'zmanim.minchaShabat' },
            // { title: 'ערבית מוצ"ש', value: 'zmanim.arvitMotash' },
          ],
          durationSec: -1,
      ...
      leftBoard: [
        ...
        },
        {
          ...
          rows: [
            { title: 'תהילים לילדים', value: '10:15' },
            { title: 'שיעור בענייני פסח', value: '17:05' },
            { title: 'מסכת ראש השנה', value: '18:05' },
            // { title: 'שיעור לנשים בתנ"ך', value: '----' },
            // { title: 'פ"ש + מסכת ראש השנה', value: 'zmanim.lessonPash' },
